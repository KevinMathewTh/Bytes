...
<div className="col-full">
    ...
    <div className="featured">
        ...
        <div className="featured__column featured__column--big">
            <div className="entry" style={{ backgroundImage: "url(" + "./assets/images/thumbs/featured/featured-guitarman.jpg" + ")" }}>
                ...
                <div className="entry__content">
                    ...
                    <div className="entry__info">
                        <a href="#0" className="entry__profile-pic">
                            <img className="avatar" src="./assets/images/avatars/user-03.jpg" alt="" />
                        </a>
        ...
        <div className="featured__column featured__column--small">
            ...
            <div className="entry" style={{ backgroundImage: "url(" + "./assets/images/thumbs/featured/featured-watch.jpg" + ")" }} >
            ...
            <div className="entry" style={{ backgroundImage: "url(" + "./assets/images/thumbs/featured/featured-beetle.jpg" + ")" }} >
